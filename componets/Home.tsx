...
const Home = () => {
    ...
    return (
      ...
      `}
            ...
            {/* Main Content */}
            <div
                className={`h-dvh w-full flex flex-col justify-center item-center bg-background transition-all duration-300 ${
                ...
                {messages.length === 0 ? (
                    <div className="py-4 w-full mx-auto flex flex-col justify-center items-center gap-2 text-center opacity-0 animate-[fadeIn_2s_ease-in-out_forwards]">
                        ...
                        <h2 className="font-semibold text-3xl">
                            Chat<span className="text-primary">Nova</span> is
                            here
                        </h2>
