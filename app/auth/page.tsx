    ...
    <div className="flex items-center justify-center h-dvh bg-background text-white">
      <div className="  p-8  w-full max-w-sm text-center">
        ...
        <div className="space-y-4">
          {/* Google */}
          {loader ? (
            <div className=" rounded-lg bg-gradient-to-br from-primary via-accent-primary to-muted  py-2 ">
              <div
                role="status "
                className="justify-center gap-2 flex items-center"
              >
                <svg
                  aria-hidden="true"
                  className="inline w-5 h-5 text-black animate-spin dark:text-black/80 fill-blue-600"
                  viewBox="0 0 100 101"
                  fill="none"
